      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-6 text-vino-text-secondary">
          ...
          <section>
            ...
            <p>
              By using Vinho, you agree to these terms. If you don't agree, please don't use the app.
          ...
          <section>
            ...
            <p>
              Vinho is a free app for tracking your wine tastings. It's provided as-is for your personal use and enjoyment.
          ...
          <section>
            ...
            <p>
              You're responsible for keeping your account secure. Don't share your password.
          ...
          <section>
            ...
            <p>
              ...
              Don't upload anything illegal or inappropriate.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Use Vinho for tracking your wine experiences. Don't try to hack it, spam it, or use it for anything illegal.
              Don't scrape our data or try to reverse engineer the app.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Vinho is provided "as is" without any warranties. We can't guarantee it will always work perfectly or be available 24/7.
          ...
          <section>
            ...
            <p>
              We're not liable for any damages from using (or not being able to use) Vinho.
              We're not responsible if your wine recommendations don't work out. You're responsible for your own wine choices.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We can modify or shut down Vinho at any time. We'll try to give you notice, but this is freeware.
