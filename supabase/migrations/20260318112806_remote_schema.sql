...
-- pg_cron is pre-installed on Supabase Cloud; not available in local Docker
...
-- FDW schema is Cloud-only (requires s3_vectors extension)
-- CREATE SCHEMA IF NOT EXISTS "fdw_vector_wine_labels";
-- ALTER SCHEMA "fdw_vector_wine_labels" OWNER TO "postgres";


-- pg_net is pre-installed on Supabase Cloud; not available in local Docker
...
-- pg_graphql is pre-installed on Supabase Cloud; not available in local Docker
...
-- pg_stat_statements is pre-installed on Supabase Cloud; not available in local Docker
...
-- supabase_vault is pre-installed on Supabase Cloud; not available in local Docker
...
-- S3 vectors FDW is Cloud-only (requires s3_vectors extension)
-- CREATE FOREIGN DATA WRAPPER "wine_labels_fdw" ...
-- CREATE SERVER "wine_labels_fdw_server" ...
-- Vault key references removed for security.
...
GRANT ALL ON FUNCTION "public"."create_default_sharing_preferences"() TO "anon";
GRANT ALL ON FUNCTION "public"."create_default_sharing_preferences"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."get_sharing_connections_with_profiles"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_tastings_with_sharing"("p_limit" integer, "p_offset" integer) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_wines_for_visual_embedding"("p_offset" integer, "p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_wines_for_visual_embedding"("p_offset" integer, "p_limit" integer) TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."invoke_generate_embeddings"("p_job_type" "text", "p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."invoke_generate_embeddings"("p_job_type" "text", "p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."invoke_generate_embeddings"("p_job_type" "text", "p_limit" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."invoke_wine_processor"() TO "anon";
GRANT ALL ON FUNCTION "public"."invoke_wine_processor"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."refresh_user_wine_stats"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."refresh_user_wine_stats"("p_user_id" "uuid") TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."trigger_refresh_user_stats"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_refresh_user_stats"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."update_user_producer_stats"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."update_user_producer_stats"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_user_producer_stats"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."update_user_region_stats"("p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."update_user_region_stats"("p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_user_region_stats"("p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."update_vintage_community_rating"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_vintage_community_rating"() TO "authenticated";
...
-- Restore search_path for subsequent seed files (db pull sets it to empty)
